  ...
  return (
    <section className="view active">
      ...
      <div className="s-card">
        ...
        <div className="s-card-desc">rclone が使用する設定ファイルの場所です。</div>
        <div className="f">
      ...
      <div className="s-card">
        ...
        <div className="s-card-desc">現在のランタイム設定と接続状態を表示します。</div>
          ...
          <pre style={{ marginTop: 12 }}>
            {JSON.stringify({
              ...
              explorer: {
                ...
                mode: appState.explorer.mode,
                selectedUploadId: appState.explorer.selectedUploadId,
